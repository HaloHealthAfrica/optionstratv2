-- Refactored Trading System Schema Alignment
-- Aligns database schema with TypeScript interfaces
-- Requirements: 9.4

-- ============================================================================
-- SIGNALS TABLE - Aligned with Signal interface
-- ============================================================================
...
-- ============================================================================
-- POSITIONS TABLE - Aligned with Position interface
-- ============================================================================
CREATE TABLE IF NOT EXISTS refactored_positions (
  ...
  -- Prevent duplicate positions for same signal
...
-- ============================================================================
-- DECISIONS TABLE - Audit trail for all decisions
-- ============================================================================
...
-- ============================================================================
-- GEX SIGNALS TABLE - Aligned with GEXSignal interface
-- ============================================================================
CREATE TABLE IF NOT EXISTS refactored_gex_signals (
  ...
  direction VARCHAR(10) NOT NULL CHECK (direction IN ('CALL', 'PUT')),
  timestamp TIMESTAMPTZ NOT NULL,
  age BIGINT, -- Milliseconds since signal
  metadata JSONB DEFAULT '{}'::jsonb,
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- ============================================================================
-- CONTEXT SNAPSHOTS TABLE - Aligned with ContextData interface
-- ============================================================================
...
-- ============================================================================
-- PIPELINE FAILURES TABLE - Track signal processing failures
-- ============================================================================
...
-- ============================================================================
-- PROCESSING ERRORS TABLE - Track system errors
-- ============================================================================
...
-- ============================================================================
ALTER TABLE refactored_signals ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_positions ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_decisions ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_gex_signals ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_context_snapshots ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_pipeline_failures ENABLE ROW LEVEL SECURITY;
ALTER TABLE refactored_processing_errors ENABLE ROW LEVEL SECURITY;
...
-- Signals policies
CREATE POLICY "Authenticated users can read refactored_signals" 
ON refactored_signals FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_signals" 
ON refactored_signals FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- Positions policies
CREATE POLICY "Authenticated users can read refactored_positions" 
ON refactored_positions FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_positions" 
ON refactored_positions FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- Decisions policies
CREATE POLICY "Authenticated users can read refactored_decisions" 
ON refactored_decisions FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_decisions" 
ON refactored_decisions FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- GEX signals policies
CREATE POLICY "Authenticated users can read refactored_gex_signals" 
ON refactored_gex_signals FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_gex_signals" 
ON refactored_gex_signals FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- Context snapshots policies
CREATE POLICY "Authenticated users can read refactored_context_snapshots" 
ON refactored_context_snapshots FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_context_snapshots" 
ON refactored_context_snapshots FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- Pipeline failures policies
CREATE POLICY "Authenticated users can read refactored_pipeline_failures" 
ON refactored_pipeline_failures FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_pipeline_failures" 
ON refactored_pipeline_failures FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);

-- Processing errors policies
CREATE POLICY "Authenticated users can read refactored_processing_errors" 
ON refactored_processing_errors FOR SELECT 
TO authenticated
USING (true);

CREATE POLICY "Service role full access to refactored_processing_errors" 
ON refactored_processing_errors FOR ALL 
TO service_role
USING (true) 
WITH CHECK (true);
